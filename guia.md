...
- **Spam:** Detecta si se está produciendo spam de 3 niveles: Nivel 1 (repetir), Nivel 2 (flood + shitposting), Nivel 3 (Spam de Copy/paste de varias lineas), Nivel 4 (Spam nivel 1 con negritas, repeticiones o links), Nivel 5 (Spam nivel 3 con negritas, repeticiones o links). (HourMute o Roomban)
