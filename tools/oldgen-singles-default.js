const POKEDEX_FILE = './../pokedex.js';
const MOVEDEX_FILE = './../moves.js';
...
module.exports = {
	...
	getViableSupportMoves: function (data) {
		...
		for (var i = 0; i < req.active[0].moves.length; i++) {
			...
			if (dataMove.name in {"Lunar Dance": 1, "Healing Wish": 1, "Assist": 1, "Nature Power": 1, "Natural Gift": 1, "Memento": 1}) continue;
