...
exports.hangmanWords = {
	...
	"Animales": ['Lechuza','Aguila Real','Bisonte','Elefante','Guepardo','Jaguar','Rinoceronte','Estrella De Mar','Delfin','Renacuajo','Salamandra','Narval','Elefante Marino','Carpincho','Murcielago','Anaconda','Pelicano','Cangrejo','Mariposa','Dragon de Komodo','Escarabajo','Cienpies','Tortuga','Comadreja','Zarigueya'],
	"Baile": ['Bachata', 'Ballet', 'Breakdancing', 'Contemporneo', 'Country', 'Cumbia', 'Disco', 'Duranguense', 'Electro', 'Fandango', 'Flamenco', 'Freestyle', 'Gangnam Style', 'Grinding', 'Hardcore', 'Harlem Shake', 'Hip hop', 'Jarabe tapatio', 'Jazz', 'Jumpstyle', 'K-pop', 'Lambada', 'Limbo', 'Macarena', 'Mambo', 'Marimba', 'Merengue', 'Polka', 'Quebradita', 'Reggaeton', 'Rock and Roll', 'Rumba', 'Salsa', 'Samba', 'Shuffle', 'Tango', 'Tap Dance', 'Tecktonik', 'Twerking', 'Twist', 'Vals', 'YMCA', 'Zamba', 'Zapateado', 'Zumba'],
	"Pokemon Showdown": ['Tier', 'Over Used', 'Under Used', 'Rarely Used', 'Never Used', 'Ubers', 'Little Cup', 'Seasonal Battles', 'Random Battle', 'Sken', 'INSANE LOVER', 'Astyanax', 'Gorka Morrison', 'xJoelituh', 'Iyarito', 'Lost Seso', 'Zarel', 'Gatto', 'Kek', 'AminitraBoTTT', 'Sken', 'Iyarito', 'Alastor Law', 'Joim', ''],
	"Frutas": ['Arandano', 'Cereza', 'Frambuesa', 'Fresa', 'Grosella', 'Guinda', 'Zarzamora', 'Mora Azul', 'Coco', 'Aceituna', 'Manzana', 'Uva', 'Limon', 'Lima', 'Naranja', 'Toronja', 'Durazno', 'Guayaba', 'Piña', 'Kiwi', 'Papaya', 'Melon', 'Melocoton', 'Ciruela'],
	"Vegetales": ['Berenjena', 'Calabacin', 'Calabaza', 'Cebolla', 'Tomate', 'Apio', 'Acelga', 'Espinaca', 'Pepinillo', 'Champiñon', 'Pimiento', 'Alcachofa', 'Brocoli', 'Coliflor', 'Lechuga', 'Patata', 'Boniato', 'Nabo', 'Rabano', 'Zanahoria', 'Mandioca', 'Soja', 'Guisantes', 'Habas', 'Remolacha'],
