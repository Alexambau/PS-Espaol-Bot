...
exports.excepts = ["ecuacion", "xjoelituh", "astyanax", "goddessbriyella", "iyarito", "lostseso"];

// Whitelisted users are those who the bot will not enforce moderation for.
exports.whitelist = [];

exports.acceptAll = false; // Battle with users
...
exports.logChat = 'espaol'; //logs the chat
